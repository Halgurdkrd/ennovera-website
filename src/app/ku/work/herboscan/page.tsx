...
export const metadata: Metadata = {
  title: 'HerboScan AI — Ennovera',
  description:
    'پلاتفۆرمی زیرەکیی ڕووەک بە هێزی AI: 2,400+ جۆر، وردیی 94%، لێکدانەوەی 1.2s. بونیادنراوە لەلایەن Ennovera.',
  alternates: {
    canonical: 'https://ennovera.com/ku/work/herboscan',
  },
}
...
const d = ku.detail
const hs = ku.herboscan

export default function KuHerboScanPage() {
  return (
      ...
      <main className="bg-canvas">
        ...
        <section className="py-16 px-6 bg-canvas border-t border-border-soft">
          <div className="max-w-3xl mx-auto text-center">
            <FadeInSection>
              <p className="text-lg text-text-muted mb-6">{hs.cta}</p>
              <a
                href="/ku/#contact"
